...
> **음성 대화 시절(2026-08-05 ~ 08-17)의 로드맵이다.** 그 기능은 2026-08-18에 제거됐고
> 개소식 운영도 끝났으므로, 여기 적힌 우선순위와 완료 기준은 **당시 기준**이다.
> 현재 남은 일은 [STATUS.md §6](../STATUS.md#6-실기-전에-사람이-해야-하는-일)에 있다.
> §5의 Locomotion↔API 검증 절차는 아직 유효하다.
